  ...
  return (
    <section className="relative z-10 section-padding">
      <div className="container-narrow">
        <h2 className="text-3xl md:text-h2 font-bold text-white text-center mb-12">
          Pourquoi les entreprises choisissent Calendia
        </h2>

        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {/* Without */}
          <div className="rounded-card border-2 border-destructive/30 p-8 bg-white/5 backdrop-blur-sm">
            <h3 className="text-h4 font-semibold text-white mb-6">Sans Calendia Pro</h3>
          ...
          {/* With */}
          <div className="relative rounded-card border-2 border-primary p-8 bg-white/10 backdrop-blur-sm shadow-card-hover">
            <span className="absolute -top-3 right-6 px-3 py-1 bg-primary text-primary-foreground text-xs font-semibold rounded-pill">
              Recommandé
            </span>
            <h3 className="text-h4 font-semibold text-white mb-6">Avec Calendia Pro</h3>
            <ul className="space-y-4">
