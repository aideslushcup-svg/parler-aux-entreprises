...
const integrationIcons: FloatingIconsHeroProps['icons'] = [
  ...
  { id: 5, icon: IconZapier, className: 'hidden md:block top-[10%] left-[35%]' },
  { id: 6, icon: IconSalesforce, className: 'hidden md:block top-[12%] right-[32%]' },
  { id: 7, icon: IconZoom, className: 'hidden md:block bottom-[14%] left-[28%]' },
  { id: 8, icon: IconCalendly, className: 'hidden md:block top-[42%] left-[10%]' },
  { id: 9, icon: IconShopify, className: 'hidden md:block top-[68%] right-[20%]' },
  { id: 10, icon: IconMake, className: 'hidden md:block bottom-[12%] left-[52%]' },
  { id: 11, icon: IconOutlook, className: 'hidden md:block top-[50%] right-[10%]' },
  { id: 12, icon: IconAirtable, className: 'hidden md:block top-[58%] left-[22%]' },
  { id: 13, icon: IconGoHighLevel, className: 'hidden md:block top-[10%] left-[56%]' },
  { id: 14, icon: IconQuickBooks, className: 'hidden md:block bottom-[12%] right-[38%]' },
  { id: 15, icon: IconFreshbooks, className: 'top-[28%] right-[18%]' },
  { id: 16, icon: IconNotion, className: 'hidden md:block top-[60%] left-[42%]' },
];
